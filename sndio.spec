...
Version  : 1.6.0
Release  : 1
URL      : http://www.sndio.org/sndio-1.6.0.tar.gz
Source0  : http://www.sndio.org/sndio-1.6.0.tar.gz
...
%prep
%setup -q -n sndio-1.6.0
cd %{_builddir}/sndio-1.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573767072
